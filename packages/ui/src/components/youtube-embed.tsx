...
export function YouTubeEmbed({
  ...
  return (
    <figure className="not-prose my-4 overflow-hidden rounded-xl border border-transparent bg-background transition-colors duration-150 hover:border-primary">
      <div className="relative aspect-video bg-muted">
        {isLoaded ? (
          ...
          >
            <img
              src={thumbnailUrl ?? getThumbnailUrl(id)}
              alt=""
