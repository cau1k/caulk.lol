...
const THEME_ENTRIES: Array<[ThemeName, string]> = [
  ["light", ""],
  ["dark", ".dark"],
]
        ...
        {payload
          ...
          .map((item, index) => {
            ...
            const indicatorStyle: ChartIndicatorStyle = {
              "--color-bg": typeof indicatorColor === "string" ? indicatorColor : undefined,
              "--color-border": typeof indicatorColor === "string" ? indicatorColor : undefined,
            }
...
function getPayloadConfigFromPayload(
  ...
  configLabelKey =
    ...
    (payloadPayload ? readStringProperty(payloadPayload, key) : undefined) ??
    key
